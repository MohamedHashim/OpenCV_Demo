package com.mohamedhashim.test.vn.edu.uit.uitanpr;
...
import com.mohamedhashim.test.android.BaseLoaderCallback;
import com.mohamedhashim.test.android.LoaderCallbackInterface;
import com.mohamedhashim.test.android.OpenCVLoader;
import com.mohamedhashim.test.com.hazuu.uitanpr.neural.KohonenNetwork;
import com.mohamedhashim.test.com.hazuu.uitanpr.neural.SampleData;
import com.mohamedhashim.test.vn.edu.uit.uitanpr.common.PlatesListAdapter;
import com.mohamedhashim.test.vn.edu.uit.uitanpr.common.Utils;
import com.mohamedhashim.test.vn.edu.uit.uitanpr.interfaces.GPSCallback;
import com.mohamedhashim.test.vn.edu.uit.uitanpr.interfaces.OnTaskCompleted;
import com.mohamedhashim.test.vn.edu.uit.uitanpr.managers.GPSManager;
import com.mohamedhashim.test.vn.edu.uit.uitanpr.models.BitmapWithCentroid;
import com.mohamedhashim.test.vn.edu.uit.uitanpr.views.CameraPreview;
...
public class MainActivity extends Activity implements OnTaskCompleted, GPSCallback{
	...
	public static final String PACKAGE_NAME = "com.mohamedhashim.test.vn.edu.uit.uitanpr";
	...
	List<org.opencv.core.Point> platePointList;
	TextView resultOCR;
	TextView gpsInfo;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(checkOpenCV)
		{
			...
			platePointList = new ArrayList<org.opencv.core.Point>();
...
//		gpsManager = null;
	...
	public class PlateView extends View implements Camera.PreviewCallback,
		...
		org.opencv.core.Rect[] platesArray;
		Bitmap og;
		List<org.opencv.core.Point> currentPlatePointList = new ArrayList<org.opencv.core.Point>();
		List<org.opencv.core.Rect> currentPlates = new ArrayList<org.opencv.core.Rect>();
		...
		protected void onDraw(Canvas canvas) {
			...
			if (plates != null) {
				...
				for (int i = 0; i < platesArray.length; i++) {
					...
					// isNewPlate?
					org.opencv.core.Point platePoint = new org.opencv.core.Point(platesArray[i].x,
							platesArray[i].y);
		...
		public class DoOCR extends AsyncTask<Void, Bitmap, String> {
			...
			private List<org.opencv.core.Rect> currentPlatesOnAsy;
			private Mat originImageOnAsy;
			private OnTaskCompleted listener;

			public DoOCR(List<org.opencv.core.Rect> currentPlates, Mat originImage,
						 OnTaskCompleted listener) {
				this.currentPlatesOnAsy = new ArrayList<org.opencv.core.Rect>(currentPlates);
			...
			protected String doInBackground(Void... params) {
				Iterator<org.opencv.core.Rect> iterator = currentPlatesOnAsy.iterator();
				...
				while (iterator.hasNext()) {
					...
					org.opencv.core.Rect plateRect = iterator.next();
					Mat plateImage;
					...
					org.opencv.core.Rect roi = new org.opencv.core.Rect((int) (x), (int) (y), (int) (w),
							(int) (h));
					...
					for (int i = 0; i < contours.size(); i++) {
						List<org.opencv.core.Point> goodpoints = new ArrayList<org.opencv.core.Point>();
						Mat contour = contours.get(i);
						int num = (int) contour.total();
						int buff[] = new int[num * 2]; // [x1, y1, x2, y2, ...]
						contour.get(0, 0, buff);
						for (int q = 0; q < num * 2; q = q + 2) {
							goodpoints.add(new org.opencv.core.Point(buff[q], buff[q + 1]));
						}

						MatOfPoint points = new MatOfPoint();
						points.fromList(goodpoints);
						org.opencv.core.Rect boundingRect = Imgproc.boundingRect(points);
						...
						if (((boundingRect.height / boundingRect.width) >= 1.5)
							...
							org.opencv.core.Point centroid = new org.opencv.core.Point(cx, cy);
							...
							if (centroid.y >= 120 && centroid.y <= 400
								...
								org.opencv.core.Rect cr = new org.opencv.core.Rect(boundingRect.x,
